...
from q2_cutadapt._format import CutadaptReadStatsDirFormat
from q2_cutadapt._type import CutadaptReadStatistics
...
plugin.register_formats(CutadaptReadStatsDirFormat)
plugin.register_semantic_type_to_format(
    FeatureTable[CutadaptReadStatistics],
    artifact_format=CutadaptReadStatsDirFormat,
)  # type: ignore
...
plugin.methods.register_function(
    ...
    outputs=[
        ...
        ("read_features", FeatureTable[CutadaptReadStatistics]),
    ],
    input_descriptions={
    ...
    output_descriptions={
        ...
        "read_features": "The read features.",
    },
